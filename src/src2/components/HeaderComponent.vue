<template>
  <header class="bg-[#A3C7D6] shadow-md py-4 relative">
    <div class="container mx-auto flex justify-between items-center px-4 sm:px-6 relative z-50">
      <!-- Mobiele menu knop -->
      ...
      <!-- Winkelwagen uiterst rechts -->
      <div class="flex items-center space-x-10 sm:order-3 ml-10">
        <RouterLink to="/Winkelwagen" class="text-gray-800 hover:text-gray-900 transition duration-300">
